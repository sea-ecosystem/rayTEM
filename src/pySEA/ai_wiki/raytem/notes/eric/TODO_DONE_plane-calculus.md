...
- [x] (3) `reference=` : accumulate from a named element instead of the
...
- [x] (2) covariance: `beam_waists(axis)` from `Sigma_12 = 0` per segment,
...
- [x] tests: frame/matrix vs ray agreement; reference= reproduces the
      entrance case; waists bracket the crossovers; thick-lens interiors
- [x] (4) write the aberrated-focal-surface plan; docs/wiki; protocol finish
