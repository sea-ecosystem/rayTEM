...
- [ ] Step 1 — root `Element` carries a working default for every propagation
...
- [ ] Step 2 — fold the aperture initial wave into the Source field machinery:
...
- [ ] Step 3 — tests (base-element transparency, aperture kind), example
